package src.course2.functionalInterfaces;/*
...
interface ExtendedDoable extends Doable {
    default void doIt() { // must have to block the inherited abstract method from colliding with the new extendedDoIt abstract method.
        System.out.println("Default method implementing doIt()");
    }
    default void doIt2() { // ok to have default methods
        System.out.println("Default method implementing doIt()");
    }
    private void doIt3() { // ok to have private methods
        System.out.println("Default method implementing doIt()");
    }
