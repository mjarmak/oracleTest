...
public class MapExample {
    ...
    private static void testMerges(Map<String, Integer> m) {
        ...
        System.out.println("Original State: " + m.toString());
        ...
        System.out.println("After merge(Mary,1000,val/3), return value : " +
                m.merge("Mary", 1000, (key, val) -> val / 3));
        System.out.println("After merge(Mary,1000,val/3): " + m);
