package src.course2.exceptions.customExceptions;/*
...
public class CheckedExamples {
    ...
    public static void main(String[] args) throws CustomException, CustomThrowable {
        ...
        // 0 means that the original IllegalStateException is passed to the constructor of CustomThrowable,
        // allowing stack trace to print information about the originating exception.
