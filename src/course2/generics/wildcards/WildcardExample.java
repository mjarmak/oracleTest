...
public class WildcardExample {
    ...
    // same erasure error
//    public static void printOVerload(List<? extends Exception> list) {
//        System.out.println("----- Using upper bound ------");
//        list.forEach((s) -> System.out.println(s.getLocalizedMessage()));
//    }
//    public static void printOVerload(List<? super Exception> list) {
//        System.out.println("----- Using lower bound ------");
//        list.forEach((s) -> System.out.println(s));
//    }
//    public static <T> void printOVerload(T value) {
//    }
//    public static void printOVerload(Object value) {
//    }
    ...
    public static <T> void printOpenDoorKinda(List<T> list) {
        System.out.println("----- Using no bounds ------");
        list.forEach((s) -> System.out.println(s));
    ...
    public static void printTest(Object list) {
        System.out.println("----- List made up of objects ------");
...
//        printUpperList(objectList); // doesn't work

        // Object allowed by <Object>
        printObjectList(objectList);

        printOpenDoorKinda(objectList); // works
        ...
        try {
            printUpperList((List) integerList);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
