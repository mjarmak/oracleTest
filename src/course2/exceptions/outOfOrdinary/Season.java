package src.course2.exceptions.outOfOrdinary;/*
...
public class Season implements AutoCloseable {
    ...
    // Overridden close method
    public void close() throws RuntimeException { // throws Throwable doesn't work because it's not a subclass of Exception
