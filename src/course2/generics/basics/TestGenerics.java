package src.course2.generics.basics;/*
...
//                new GenericallyTypedClass<int>(10);
        ...
        Object o = raw1.currentObj; //  only Object works. Not good

        // error because o is of type String.
        // We must build our own type checking code
//        StringBuilder s1 = (StringBuilder) o;

        String o2 = generic1.currentObj; // only String works because the type was specified

        generic1 = new GenericallyTypedClass<>("1");

        generic1 = new GenericallyTypedClass(new StringBuilder("hello"));
//        String s3 = generic1.currentObj; // error

        generic1 = new GenericallyTypedClass<>("1");
        String s4 = generic1.currentObj; // error
    }
}