package src.course2.generics.collections.set;/*
...
public class SetExample {
    ...
    public static void main(String[] args) {
        ...
        h.add(null);
        if (h.equals(l)) {
            System.out.println("HashSet h is equal to LinkedHashSet l after adding a null");
        } else {
            System.out.println("HashSet h is NOT equal to LinkedHashSet l after adding a null");
        }
