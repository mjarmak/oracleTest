...
//        GenericClassBound<Boolean> b3 = new GenericClassBound<>();

//        Exception is not a comparable
...
//doesn't work
//class GenericMixedBounded2<T extends Comparable<Integer> & Comparable<String>> {
//}