...
public class StringConstructor {
    ...
    public static void main(String[] args) {
        ...
        String intString = new String(integers, 0, alphabet_len); // Can give error if offset will make the length exceed the bounds of the string.
        System.out.println("intString = " + intString);

        // Create a String from the character array
        int offset = 1;
        String charString2 = new String(alphabet, offset, alphabet_len - offset); // Fix with (length - o0ffset)
