package src.course2.funfamentals.classes;/*
    ...
    private void methodWithLocalClass() {
        ...
        class LocalClass {
            ...
            private LocalClass(String name) {
                ...
                this.name += " " + LocalClassExample.this.lastName; // unnessary, can just be this.name += " " + lastName
            }
...
//            Inner classes cannot have static declarations or enums
//            static final String nestedString;
//            enum values {
//                ONE, TWO
//            }
