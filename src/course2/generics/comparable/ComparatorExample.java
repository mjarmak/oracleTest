package src.course2.generics.comparable;/*
...
//        Arrays.sort(names, new LastNameComparator()); // custom sorting
        Arrays.sort(names); // alphabetical sorting
